        ...
        <v-flex xs10 pt-5 pb-5>
          <div class="text-xs-center">
            ...
            <v-card-text class="grey--text  text--darken-2 subheading">
              ...
              address). This privacy notice applies solely to information
              ...
              information. Information Collection, Use, and Sharing We are the
              sole owners of the information collected on this site. We only
              have access to/collect information that you voluntarily give us
              via email or other direct contact from you. We will not sell or
              ...
              e.g. to ship an order. Unless you ask us not to, we may contact
              you via email in the future to tell you about specials, new
              products or services, or changes to this privacy policy. Your
              Access to and Control Over Information You may opt out of any
              future contacts from us at any time. You can do the following at
              any time by contacting us via the email address or phone number
              given on our website: See what data we have about you, if any.
              ...
              your data. Security We take precautions to protect your
              ...
              address of the Web page. While we use encryption to protect
              ...
              information are kept in a secure environment. If you feel that we
              are not abiding by this privacy policy, you should contact us
              immediately via telephone at (803) 354-2363
            </v-card-text>
          </div>
        </v-flex>
      </v-layout>
